...
public class InterruptShortPacketIOTests extends TestCase
{
     ...
     * Constructor
     */
    public InterruptShortPacketIOTests()
    {
        super();
    };

    protected InterruptShortPacketIOTests(UsbDevice newUsbDevice, List newUsbPipeList, byte newEndpointType)
    {
