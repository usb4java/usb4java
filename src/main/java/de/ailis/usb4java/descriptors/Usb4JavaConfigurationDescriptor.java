 ...
 */
public final class Usb4JavaConfigurationDescriptor extends
    Usb4JavaDescriptor<USB_Config_Descriptor> implements
    UsbConfigurationDescriptor
{
     ...
     */
    public Usb4JavaConfigurationDescriptor(final USB_Config_Descriptor
        descriptor)
    {
        super(descriptor);
    }
    ...
    public boolean equals(final Object o)
    {
        ...
        final Usb4JavaConfigurationDescriptor other =
            (Usb4JavaConfigurationDescriptor) o;
